package com.shermatov.dreamshops.service.category;
...
public class CategoryService implements ICategoryService {
    ...
    public Category addCategory(Category category) {
        return Optional.of(category).filter(c -> !categoryRepository.existsByName(
                c.getName())).map(categoryRepository :: save).
